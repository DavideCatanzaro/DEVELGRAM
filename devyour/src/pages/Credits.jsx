                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-5">
                        ...
                        <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-gradient-to-t from-[#ea80fc] to-[#80d8ff] rounded-xl">
                            ...
                            <div className="flex mt-3 -mx-2 rounded-md">
                                <a href="#" className="mx-2 text-grey dark:text-white hover:text-grey dark:hover:text-white group-hover:text-grey" ariaLabel="DevYour">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                                    </svg>
                                </a>

                                <a href="#" className="mx-2 text-grey dark:text-white hover:text-grey dark:hover:text-white group-hover:text-grey" ariaLabel="Linkedin">
                        ...
                        <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-gradient-to-t from-[#80d8ff] to-[#ea80fc] rounded-xl">
                            <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="./assets/credits/Davide.jpg" alt="Davide Catanzaro" />
                        ...
                        <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-gradient-to-t from-[#ea80fc] to-[#80d8ff] rounded-xl">
                            <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="./assets/credits/Luca-credits.png" alt="Luca Giuntoli" />

                            <h1 className="flex flex-col items-center mt-4 text-2xl font-semibold text-grey capitalize dark:text-white group-hover:text-grey rounded-md"><span className="rounded-md">Luca</span><span className="rounded-md">Giuntoli</span></h1>
                        ...
                        <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-gradient-to-t from-[#ea80fc] to-[#80d8ff] rounded-xl">
                            <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="./assets/credits/Pietro-profile.jpg" alt="Pietro Amato" />
