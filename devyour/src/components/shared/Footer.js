...
const Footer = () => {
    return (
        <footer className="relative mt-20 bg-white px-4 pt-20">
            ...
            <nav aria-label="Footer Navigation" className="mx-auto mb-10 flex items-center justify-center max-w-lg flex-col gap-5 text-center sm:flex-row sm:text-left bg-white">
