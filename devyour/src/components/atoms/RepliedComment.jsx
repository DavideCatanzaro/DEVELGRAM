    ...
    <>
      <div className="mb-3 space-y-4 py-2 focus:outline-none " >
        <div className="relative flex items-center">
          <img className="h-10 w-10 rounded-full object-cover" src="https://png.pngtree.com/png-vector/20191009/ourlarge/pngtree-user-icon-png-image_1796659.jpg" alt="Simon Lewis" />
          <div className="ml-4 flex flex-col sm:w-96">
            ...
            <div className="mb-2 text-sm text-grey">
              ...
              <span className="mr-1 font-medium text-blue"> replied to your comment: </span>
            ...
            <div className="rounded-xl bg-blue p-4 text-grey">
              <p className="text-sm bg-blue"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum, soluta modi? Amet, sequi distinctio. </p>
            </div>
          </div>
