    ...
    <>
      <div className="mb-3 space-y-4 py-2 focus:outline-none ">
        <div className="relative flex items-center">
          <img className="h-10 w-10 mb-14 rounded-full object-cover" src="https://png.pngtree.com/png-vector/20191009/ourlarge/pngtree-user-icon-png-image_1796659.jpg" alt="img" />
          <div className="ml-4 flex flex-col sm:w-96">
            ...
            <div className=" flex text-sm text-grey">
              ...
              <span className="mr-1 font-medium text-pink"> liked your post: </span>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTD3y8Eo9yo-VTrjq1pgCyR6PGkaTvNqrjrSZR4omN0UZeuu7jUjZXSKr4RMRteO_kTM3E&usqp=CAU" alt="img" className=" h-30 w-20 ml-10  border object-cover" />
            </div>
          </div>
