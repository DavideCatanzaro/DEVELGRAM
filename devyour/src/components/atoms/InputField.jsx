...
const InputVariants = {
    ...
    thirdInputVariant: " w-full h-7 py-2 pl-1 pr-4 text-grey bg-transparent border rounded-md dark:bg-white dark:text-grey dark:border-white focus:border-blue focus:outline-none hover:placeholder-blue placeholder-grey ",
}
